...
async function loadVideo(cameraLabel, state) {
  ...
  console.log('state.video', state.video); // state.video.style.display='block'
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (i) {
        switch (i.label) {
          ...
          case 1:
            return e.model = i.sent(), [4, this.model.executeAsync((0, tf.zeros)([1, 300, 300, 3]))];
...
},{"@tensorflow/tfjs-converter":"node_modules/@tensorflow/tfjs-converter/dist/tf-converter.esm.js","@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js"}],"model/coco-ssd.js":[function(require,module,exports) {
"use strict";
...
exports.executeInRealTime = executeInRealTime;
...
async function loadModel(state, baseModel = 'lite_mobilenet_v2') {
  state.net = await cocoSsd.load({
    base: baseModel
  });
}

function executeInRealTime(state, stats) {
...
},{"@tensorflow-models/coco-ssd":"node_modules/@tensorflow-models/coco-ssd/dist/coco-ssd.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _cocoSsd = require("./model/coco-ssd");
...
async function bindPage() {
  await (0, _cocoSsd.loadModel)(state);
  ...
  setupFPS();
  (0, _cocoSsd.executeInRealTime)(state, stats);
}
...
bindPage();
},{"stats.js":"node_modules/stats.js/build/stats.min.js","./helpers":"helpers.js","./model/coco-ssd":"model/coco-ssd.js"}]},{},["index.js"], null)
